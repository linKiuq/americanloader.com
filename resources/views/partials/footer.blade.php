    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div>
                <div class="flex items-center gap-2 mb-4">
                    <span class="inline-flex h-9 w-9 items-center justify-center rounded bg-blue-600 text-white font-black">S</span>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('welcome') }}" class="text-gray-600 hover:text-blue-600 transition">Home</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('equipment') }}" class="text-gray-600 hover:text-blue-600 transition">Browse Products</a></li>
                    <li><a href="{{ route('contact') }}" class="text-gray-600 hover:text-blue-600 transition">Request Quote</a></li>
                    <li><a href="{{ route('contact') }}" class="text-gray-600 hover:text-blue-600 transition">Parts & Service</a></li>
                    <li><a href="{{ route('contact') }}" class="text-gray-600 hover:text-blue-600 transition">Warranty Help</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="space-y-2 text-sm text-gray-600">
                    <p><a href="mailto:digital@typhonmachinery.com" class="hover:text-blue-600 transition">digital@typhonmachinery.com</a></p>
                    <p><a href="tel:+15551234567" class="hover:text-blue-600 transition">+1 (555) 123-4567</a></p>
        ...
        <div class="mt-10 border-t border-gray-200 pt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex gap-5 text-sm font-semibold">
                ...
                <a href="{{ route('about') }}" class="text-gray-500 hover:text-blue-600 transition">Company</a>
                <a href="{{ route('contact') }}" class="text-gray-500 hover:text-blue-600 transition">Support</a>
            </div>
        </div>
    </div>
</footer>
