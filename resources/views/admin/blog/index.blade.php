                ...
                @forelse ($posts as $post)
                    <tr>
                        <td class="px-6 py-5">
                            ...
                            <p class="mt-2 text-xs font-semibold uppercase tracking-wide text-red-800">{{ $post->category?->name ?? 'Uncategorized' }}</p>
                        </td>
                        <td class="px-6 py-5">
                        ...
                        <td class="px-6 py-5">
                            <div class="flex justify-end gap-3">
                                @if ($post->is_published)
                                    <a href="{{ route('blog.show', $post->slug) }}" class="font-bold text-slate-500 hover:text-red-700">View</a>
                                @endif
                                <a href="{{ route('admin.blog.edit', $post) }}" class="font-bold text-red-700 hover:text-red-800">Edit</a>
