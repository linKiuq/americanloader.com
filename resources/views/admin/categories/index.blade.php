...
@section('content')
    <div class="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <a href="{{ route('admin.categories.create') }}" class="rounded-lg bg-red-500 px-6 py-4 text-center text-sm font-black uppercase tracking-wider text-white hover:bg-red-500">New Category</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-5">
                            <div class="flex justify-end gap-3">
                                <a href="{{ route('admin.categories.edit', $category) }}" class="font-bold text-red-700 hover:text-red-800">Edit</a>
