    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-gray-50">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
                ...
                <div class="bg-gradient-to-br from-white to-white rounded-xl p-8 border border-yellow-500 border-opacity-30">
                    <div class="grid grid-cols-2 gap-6">
                        <div class="text-center">
                            <h3 class="text-4xl font-bold text-yellow-400 mb-2">14+</h3>
                            <p class="text-gray-600">Years of Excellence</p>
                        </div>
                        <div class="text-center">
                            <h3 class="text-4xl font-bold text-yellow-400 mb-2">2000+</h3>
                        ...
                        <div class="text-center">
                            <h3 class="text-4xl font-bold text-yellow-400 mb-2">98%</h3>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="value-card p-8 rounded-xl cursor-pointer group">
                    <div class="w-16 h-16 bg-yellow-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition">
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="bg-gradient-to-br from-white to-white rounded-xl p-8 border border-yellow-500 border-opacity-30">
                    <div class="mb-8">
                        <h3 class="text-2xl font-bold text-gray-950 mb-4 flex items-center">
                            <i class="fas fa-map-marker-alt text-yellow-500 mr-3 text-3xl"></i>
                            Commerce, California
                        </h3>
                    </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white p-6 rounded-lg border border-yellow-500 border-opacity-20">
                        <h4 class="text-xl font-bold text-gray-950 mb-3 flex items-center">
                            <i class="fas fa-industry text-yellow-500 mr-2 text-2xl"></i>
                    ...
                    <div class="bg-white p-6 rounded-lg border border-yellow-500 border-opacity-20">
                        <h4 class="text-xl font-bold text-gray-950 mb-3 flex items-center">
                            <i class="fas fa-leaf text-yellow-500 mr-2 text-2xl"></i>
                            Sustainability
                        </h4>
                    ...
                    <div class="bg-white p-6 rounded-lg border border-yellow-500 border-opacity-20">
                        <h4 class="text-xl font-bold text-gray-950 mb-3 flex items-center">
                            <i class="fas fa-graduation-cap text-yellow-500 mr-2 text-2xl"></i>
                            Training Center
                        </h4>
                    ...
                    <div class="bg-white p-6 rounded-lg border border-yellow-500 border-opacity-20">
                        <h4 class="text-xl font-bold text-gray-950 mb-3 flex items-center">
                            <i class="fas fa-truck mr-2 text-yellow-500 text-2xl"></i>
                            Logistics Hub
                        </h4>
