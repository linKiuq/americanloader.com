    ...
    <main>
        <header class="border-b border-gray-200 bg-gradient-to-r from-white to-gray-50 py-16">
            <div class="mx-auto max-w-7xl px-4 text-center">
                <p class="mb-3 text-xs font-black uppercase tracking-[0.3em] text-red-700">Equipment Knowledge</p>
        ...
        <section class="mx-auto grid max-w-7xl gap-6 px-4 py-14 md:grid-cols-2 lg:grid-cols-5">
            <a href="{{ route('blog.index') }}" class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:border-red-500 hover:shadow-md">
                <h2 class="font-black uppercase text-[#071d38]">Blog</h2>
                <p class="mt-3 text-sm text-gray-600">News and machine walkthroughs.</p>
            </a>
            <a href="{{ route('topics.show', 'buy-guides') }}" class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:border-red-500 hover:shadow-md">
                <h2 class="font-black uppercase text-[#071d38]">Buy Guides</h2>
                <p class="mt-3 text-sm text-gray-600">Choose the right equipment.</p>
            </a>
            <a href="{{ route('topics.show', 'features') }}" class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:border-red-500 hover:shadow-md">
                <h2 class="font-black uppercase text-[#071d38]">Features</h2>
                <p class="mt-3 text-sm text-gray-600">Understand capabilities.</p>
            </a>
            <a href="{{ route('topics.show', 'workspace') }}" class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:border-red-500 hover:shadow-md">
                <h2 class="font-black uppercase text-[#071d38]">Workspace</h2>
                <p class="mt-3 text-sm text-gray-600">Plan site operations.</p>
            </a>
            <a href="{{ route('topics.show', 'safety') }}" class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:border-red-500 hover:shadow-md">
                <h2 class="font-black uppercase text-[#071d38]">Safety</h2>
