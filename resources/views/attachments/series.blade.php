...
<head>
    ...
    <title>{{ $series['title'] }} - Skoop Loaders</title>
    ...
    <main class="py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10 text-center">
                <p class="text-sm font-semibold uppercase tracking-[0.3em] text-blue-600">Skid Steer Attachments</p>
            ...
            <div class="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
                ...
                <ul class="space-y-4 text-gray-600">
                    @foreach($series['details'] as $detail)
                        <li class="flex gap-3">
                            <span class="mt-1 h-3.5 w-3.5 rounded-full bg-blue-600"></span>
                            <span>{{ $detail }}</span>
                        </li>
                    @endforeach
                </ul>
            ...
            <div class="mt-8 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
                ...
                <a href="{{ route('contact') }}" class="inline-flex items-center justify-center rounded-xl border border-gray-300 bg-gray-50 px-6 py-4 text-sm font-black uppercase tracking-wider text-gray-950 hover:border-blue-500 hover:text-blue-700 transition">Request Quote</a>
            </div>
        </div>
    </main>
