    ...
    <main class="flex-grow px-4 py-12 sm:px-6">
        <div class="mx-auto max-w-3xl">
            <section class="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm sm:p-10">
                ...
                <p class="mb-2 text-xs font-black uppercase tracking-[0.22em] text-red-700">Order Received</p>
                <h1 class="text-3xl font-black">Thank you, {{ $order['customer']['name'] }}.</h1>
                <p class="mt-4 text-gray-600">Your equipment order <strong class="text-[#071d38]">{{ $order['number'] }}</strong> was submitted on {{ $order['placed_at'] }}.</p>
                ...
                <a href="{{ route('equipment') }}" class="mt-8 inline-flex rounded-xl bg-red-700 px-7 py-4 text-sm font-black uppercase tracking-wider text-white hover:bg-red-800">Continue Shopping</a>
            </section>
        </div>
    </main>
